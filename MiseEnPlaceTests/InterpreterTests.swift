...
class InterpreterTests: XCTestCase {
    ...
    func testUSMass() {
        ...
        XCTAssertTrue(sOzMass == "2" + Fraction.twoThirds.symbol + " Ounce")
        ...
        XCTAssertTrue(lOzMass == "8" + Fraction.oneHalf.symbol + " Ounce")
        ...
        XCTAssertTrue(lb2 == "2 Pound 8" + Fraction.threeFourths.symbol + " Ounce")
