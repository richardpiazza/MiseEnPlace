...
public struct Ratio: Equatable, CustomStringConvertible {
    ...
    public init(_ proportioned: Proportioned) {
        volume = proportioned.volume
        weight = proportioned.weight
    }
    ...
    public var description: String {
        ...
        #else
        let vC: CVarArg? = v.withCString { $0 }
        let wC: CVarArg? = w.withCString { $0 }
...
private var significantDigitFormatter: NumberFormatter = {
