...
/// # Multimedia
///
/// Parameter and helper methods for managing a single image representation
/// of an object.
///
/// ## Requied Conformance
///
...
public extension Multimedia {
    ...
    public mutating func copyImage(atURL url: URL) {
    ...
    public mutating func writeImage(_ data: Data, name: String = UUID().uuidString, ext: String = "png") {
